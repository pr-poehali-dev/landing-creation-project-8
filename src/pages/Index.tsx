      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Реальные цифры от наших курьеров
            </p>
          </div>
            ...
            {[
              {
                ...
                period: 'в день',
                amount: '60 000',
                description: 'Подработка после учёбы или работы'
              },
              {
                hours: '8 часов',
                period: 'в день',
                amount: '120 000',
                description: 'Стандартная занятость 5 дней в неделю',
                highlighted: true
              },
              {
                hours: '10+ часов',
                period: 'в день',
                amount: '200 000+',
                description: 'Максимальный заработок для целеустремлённых'
              }
            ].map((plan, index) => (
              <Card key={index} className={`relative ${plan.highlighted ? 'border-2 border-primary shadow-lg scale-105' : 'border-border'}`}>
                {plan.highlighted && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-primary text-secondary font-semibold">Популярно</Badge>
                  </div>
                )}
                <CardHeader className="text-center pb-4">
                  <div className="text-4xl mb-2">💵</div>
                  <div className="text-sm text-muted-foreground mb-4">{plan.hours} {plan.period}</div>
                  <div className="text-5xl font-bold mb-2">
                    {plan.amount} <span className="text-2xl">₽</span>
                  </div>
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-muted-foreground">
              * Расчёт основан на средней стоимости заказа 200 ₽ и 10 заказов за смену. Ваш доход зависит от количества выполненных заказов.
            </p>
          </div>
        </div>
      </section>
